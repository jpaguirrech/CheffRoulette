...
// ─── MOCK DATA ────────────────────────────────────────────────────────
const RECIPES = [
  { id: 'r1', title: 'Birria Tacos', cuisine: 'Mexican', time: 45, diff: 'Medium', src: 'tiktok',    user: '@chefmaya',      likes: 1240, spicy: 2, img: 'https://images.unsplash.com/photo-1599974579688-8dbdd335c77f?w=800&q=75',
    tags: ['Comfort', 'Weeknight'], blurb: 'Slow-braised beef, crispy tortillas, dipped in consommé.' },
  { id: 'r2', title: 'Gochujang Pasta', cuisine: 'Fusion',  time: 20, diff: 'Easy',   src: 'instagram', user: '@seoulfoodies',   likes: 3211, spicy: 2, img: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=800&q=75',
    tags: ['Quick', 'Spicy'], blurb: 'Spicy, creamy, 10 ingredients or less.' },
  { id: 'r3', title: 'Miso Glazed Salmon', cuisine: 'Japanese', time: 25, diff: 'Easy', src: 'youtube', user: '@ramsaycooks', likes: 8720, spicy: 0, img: 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?w=800&q=75',
    tags: ['Healthy', 'Date night'], blurb: 'Sweet-savory miso glaze, flaky salmon, rice on the side.' },
  { id: 'r4', title: 'Arepa de Huevo', cuisine: 'Colombian', time: 30, diff: 'Medium', src: 'tiktok',  user: '@cocinacolombia', likes: 560, spicy: 1, img: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=75',
    tags: ['Breakfast', 'Fried'], blurb: 'Fried corn pocket stuffed with a whole egg.' },
  { id: 'r5', title: 'Burrata Peach Toast', cuisine: 'Italian', time: 10, diff: 'Easy', src: 'pinterest', user: '@tastemade', likes: 912, spicy: 0, img: 'https://images.unsplash.com/photo-1565299543923-37dd37887442?w=800&q=75',
    tags: ['Summer', 'No-cook'], blurb: 'Honey, peaches, torn burrata, flaky salt.' },
  { id: 'r6', title: 'Thai Green Curry', cuisine: 'Thai', time: 35, diff: 'Medium', src: 'youtube', user: '@painternal', likes: 4002, spicy: 3, img: 'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?w=800&q=75',
    tags: ['Comfort', 'Spicy'], blurb: 'Fragrant, creamy, herby — ready in 35.' },
  { id: 'r7', title: 'Crispy Rice Salad', cuisine: 'Thai', time: 15, diff: 'Easy', src: 'tiktok', user: '@hot_thai_kitchen', likes: 2200, spicy: 1, img: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=800&q=75',
    tags: ['Fresh', 'Crunchy'], blurb: 'Golden rice clusters, herbs, lime.' },
  { id: 'r8', title: 'Smash Burger', cuisine: 'American', time: 15, diff: 'Easy', src: 'instagram', user: '@burgerchef', likes: 6100, spicy: 0, img: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=75',
